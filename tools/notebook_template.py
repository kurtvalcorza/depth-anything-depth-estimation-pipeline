...
TEMPLATE = {
    ...
    "byod": (
        ...
        "RGB-D records as a `.zip` holding `records.csv` (columns `id`, `image`, `depth`, optional `mask` and `group`) beside "
